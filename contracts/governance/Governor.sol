...
abstract contract GovernorEvents {
...
contract Governor is GovernorStorage, GovernorEvents {
    ...
    uint256 public constant quorumVotes = 40_000_000 * 1e18; // 40,000,000 = 4% of FOXS // TODO: veFOXS
     ...
     * @param veFoxs_ The address of the veFOXS token
    ...
    constructor(
        ...
        require(
            veFoxs_ != address(0),
            "Governor::initialize: invalid veFOXS address"
        );

        timelock = ITimelock(address(new Timelock(7 days)));
        veFOXS = IveFOXS(veFoxs_);
    ...
    function castVoteInternal(
        ...
        uint96 votes = veFOXS.getPriorVotes(voter, proposal.startBlock);
